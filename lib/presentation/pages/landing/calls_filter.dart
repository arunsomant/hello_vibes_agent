...
class CallsFilter extends GetView<CallsFilterController> {
  const CallsFilter({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AppText('Call Type', type: AppTextType.t14sb),
            Obx(() {
              return Wrap(
                spacing: AppSpacings.s8,
                runSpacing: AppSpacings.s8,
                crossAxisAlignment: WrapCrossAlignment.center,
                children: List.generate(controller.callTypes.length, (index) {
                  final callType = controller.callTypes[index];
                  final selected =
